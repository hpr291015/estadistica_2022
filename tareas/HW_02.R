...
# Aplicar la funcion subset para la variable Altura:
...
# Estadasticas basicas ----------------------------------------------------

# Determinar la media (mean) de los objetos (variable y respectivos subsets), asi como su desviacion estandar (sd).
